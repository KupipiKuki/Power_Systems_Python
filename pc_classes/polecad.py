...
class poleCalculationClass():
    ...
    def prepData(self):
        ...
        self.cabledb=dfn.generate_cable_database()
    ...
    def poleLaunch(self,projectname,projectdir,designTension,strengthFactor,windLoad,windOverload,tensionOverload,iceThickness,windAngle,deflectionFactor,overrideSpan=False,overrideAngle=False):
